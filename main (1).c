...
int main()
{
    ...
    while (!stop)
    {
        ...
        case 2:
            ClearScrean();
            for (int k = 1; k <= 3; k++)
                AffichageBloc(nomFichier, k);
            printf("\n\t >> ");
            system("PAUSE");
            break;
        case 3:
            InsererEnreg(nomFichier, tabIndex);
            printf("\n\t >> ");
            system("PAUSE");
            break;
        case 4:
            ModifierRegion(nomFichier, tabIndex);
            printf("\n\t >> ");
            system("PAUSE");
            break;
        case 5:
            SupprimSelonMatricule(tabIndex, nomFichier);
            printf("\n\t >> ");
            system("PAUSE");
            break;
        case 6:
            SupprimSelonForces(nomFichier, tabIndex);
            printf("\n\t >> ");
            system("PAUSE");
            break;
        case 7:
            AfficherSelonGrades(nomFichier);
            printf("\n\t >> ");
            system("PAUSE");
            break;
        case 8:
            AfficherSelonRegionAge(nomFichier);
            printf("\n\t >> ");
            system("PAUSE");
            break;
        case 9:
            Fragmentation(nomFichier);
            printf("\n\t >> ");
            system("PAUSE");
            break;
        case 10:
